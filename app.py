...
with st.sidebar:
    ...
    sections = {
        ...
        "Roll Factor Analysis": {
            "Select an option...": "Select an option...",
            'AM/LF/PD Positioning': 'AM/LF/PD Positioning',
            'Optionality': 'Optionality',
            'RV vs. Spline': 'RV vs. Spline',
            'Repo': 'Repo',
        }
    }
...
### ---------------------------------------------------------------------------------------- ###
    ...
    st.title('TU')
    app_am_lf_pd_pos.real_fast_tu(start_date,end_date)
    st.title('FV')
    app_am_lf_pd_pos.real_fast_fv(start_date,end_date)
    st.title('TY')
    app_am_lf_pd_pos.real_fast_ty(start_date,end_date)
    st.title('UXY')
    app_am_lf_pd_pos.real_fast_uxy(start_date,end_date)
    st.title('US')
